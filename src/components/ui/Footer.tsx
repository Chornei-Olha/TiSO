...
const socials: SocialItem[] = [
  {
    type: 'icon',
    icon: Linkedin,
    link: 'https://www.linkedin.com/company/11491230/admin/dashboard/',
  },
  {
    type: 'icon',
    icon: Youtube,
    link: 'https://www.youtube.com/channel/UC3BG4Q45UALA46Sm67m8PyA ',
  },
      ...
      <div className="mx-auto max-w-[1440px] px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col gap-8 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div>
            ...
            <div className="flex flex-col mt-3 space-y-2 text-[14px] text-[#b4b4b4]">
              <a href="mailto:sales@tiso.global" className="hover:underline">
                sales@tiso.global
              </a>{' '}
              <a href="https://tiso.global/en/" className="text-white underline">
